...
# RIP Cre6 :'(
    ...
    'Cre7': ({'date': '18_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 3, 'novel_arm': 1, 'ravel_ind': 0},
             {'date': '19_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 1},
             {'date': '20_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 1, 'novel_arm': 1, 'ravel_ind': 2},
             {'date': '21_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 3},
             {'date': '22_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 3, 'novel_arm': 1, 'ravel_ind': 4},
             {'date': '23_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 5},
            ({'date': '24_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 6},
             {'date': '24_10_2020', 'scene': 'YMaze_RewardReversal', 'session': 2, 'scan': 6, 'novel_arm': 1, 'ravel_ind': 7},),
             {'date': '25_10_2020', 'scene': 'YMaze_RewardReversal', 'session': np.nan, 'scan': np.nan, 'novel_arm': 1, 'ravel_ind': 8},
            ({'date': '26_10_2020', 'scene': 'YMaze_RewardReversal', 'session': np.nan, 'scan': np.nan, 'novel_arm': 1, 'ravel_ind': 9},
             {'date': '26_10_2020', 'scene': 'YMaze_LNovel', 'session': np.nan, 'scan': np.nan, 'novel_arm': 1, 'ravel_ind': 10},),
             ),

    'Cre8': ({'date': '16_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 7, 'novel_arm': 1, 'ravel_ind': 0},
             {'date': '17_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 1},
             {'date': '18_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 5, 'novel_arm': 1, 'ravel_ind': 2},
             {'date': '19_10_2020', 'scene': 'YMaze_LNovel', 'session': 3, 'scan': 6, 'novel_arm': 1, 'ravel_ind': 3},
             {'date': '21_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 4},
             {'date': '21_10_2020', 'scene': 'YMaze_LNovel', 'session': 2, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 5},
            ({'date': '23_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 6},
             {'date': '23_10_2020', 'scene': 'YMaze_RewardReversal', 'session': 1, 'scan': 4, 'novel_arm': 1, 'ravel_ind': 7},),
             {'date': '23_10_2020', 'scene': 'YMaze_RewardReversal', 'session': 1, 'scan': 2, 'novel_arm': 1, 'ravel_ind': 8},
    ...
    'Cre9': ({'date': '18_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': -1, 'ravel_ind': 0},
             {'date': '19_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': -1, 'ravel_ind': 1},
             {'date': '20_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 4, 'novel_arm': -1, 'ravel_ind': 2},
             {'date': '21_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': -1, 'ravel_ind': 3},
             {'date': '23_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 2, 'novel_arm': -1, 'ravel_ind': 4},
             {'date': '23_10_2020', 'scene': 'YMaze_LNovel', 'session': 2, 'scan': 2, 'novel_arm': -1, 'ravel_ind': 5},
            ({'date': '24_10_2020', 'scene': 'YMaze_LNovel', 'session': 1, 'scan': 3, 'novel_arm': -1, 'ravel_ind': 6},
             {'date': '24_10_2020', 'scene': 'YMaze_RewardReversal', 'session': 1, 'scan': 5, 'novel_arm': -1, 'ravel_ind': 7},),
             {'date': '25_10_2020', 'scene': 'YMaze_RewardReversal', 'session': np.nan, 'scan': np.nan, 'novel_arm': -1, 'ravel_ind': 8},
            ({'date': '26_10_2020', 'scene': 'YMaze_RewardReversal', 'session': np.nan, 'scan': np.nan, 'novel_arm': -1, 'ravel_ind': 9},
             {'date': '26_10_2020', 'scene': 'YMaze_LNovel', 'session': np.nan, 'scan': np.nan, 'novel_arm': -1, 'ravel_ind': 10},),
             ),
